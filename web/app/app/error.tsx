...
export default function AppError({
  ...
  return (
    <main className="mx-auto max-w-shell px-6 py-16 lg:px-8">
      <div className="text-[11px] uppercase tracking-[0.2em] text-ink-muted">主系统错误</div>
      <h1 className="mt-4 font-headline text-5xl font-extrabold tracking-tight text-ink-text">当前页面没有正常载入</h1>
      <p className="mt-5 max-w-2xl text-sm leading-7 text-ink-muted">{error.message || "可以先重试一次，或者回到 Agent 控制台继续工作。"}</p>
