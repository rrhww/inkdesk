...
- 验证： `server/tests/*`
- 验证： `web/tests/*`
- 验证： `docs/superpowers/specs/2026-05-02-问答研究员设计.md`
- 验证： `docs/superpowers/plans/2026-05-02-问答研究员实施计划.md`
